...
class etra_downsample_comparison:
    ...
    def draw(Hz1000, Hz30_wo, Hz30_w_cubic, Hz30_w_linear, value): #upsampledHz1000
        ...
        plt.title(f"{value}: ETRA_500_to_30Hz")
        plt.xlabel('timestep')
    ...
    x_30_wo = np.loadtxt(f"ETRA_500Hz_subj {subj}_stim {stim}.bmp/ETRA_500Hz_to_30Hz_Downsample_wo_interpol_subj {subj}_stim {stim}.bmp_x.csv", delimiter=',')
    x_30_wo = np.transpose(x_30_wo)
    x_30_w_cubic = np.loadtxt(f"ETRA_500Hz_subj {subj}_stim {stim}.bmp/ETRA_500Hz_to_30Hz_Downsample_w_interpol_cubic_subj {subj}_stim {stim}.bmp_x.csv", delimiter=',')
    x_30_w_cubic = np.transpose(x_30_w_cubic)
    x_30_w_linear = np.loadtxt(f"ETRA_500Hz_subj {subj}_stim {stim}.bmp/ETRA_500Hz_to_30Hz_Downsample_w_interpol_linear_subj {subj}_stim {stim}.bmp_x.csv", delimiter=',')
    ...
    y_30_wo = np.loadtxt(f"ETRA_500Hz_subj {subj}_stim {stim}.bmp/ETRA_500Hz_to_30Hz_Downsample_wo_interpol_subj {subj}_stim {stim}.bmp_y.csv", delimiter=',')
    y_30_wo = np.transpose(y_30_wo)
    y_30_w_cubic = np.loadtxt(f"ETRA_500Hz_subj {subj}_stim {stim}.bmp/ETRA_500Hz_to_30Hz_Downsample_w_interpol_cubic_subj {subj}_stim {stim}.bmp_y.csv", delimiter=',')
    y_30_w_cubic = np.transpose(y_30_w_cubic)
    y_30_w_linear = np.loadtxt(f"ETRA_500Hz_subj {subj}_stim {stim}.bmp/ETRA_500Hz_to_30Hz_Downsample_w_interpol_linear_subj {subj}_stim {stim}.bmp_y.csv", delimiter=',')
