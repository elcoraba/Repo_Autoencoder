...
class RepresentationEvaluator:
    def __init__(self, tasks, classifiers='all', args=None, **kwargs):
        ...
        if 'model' in kwargs:
            ...
            self.representation_name = 'TODO_useful representation name in evaluatepy' # kwargs['representation_name']
    ...
    def evaluate(self, e=None):
        ...
        for i, task in enumerate(self.tasks):
            ...
            for classifier, params_grid in self.classifiers:    #self.classifier: ('svm_linear', SVC() ),{'svm_linear__kernel': ['linear'], 'svm_linear__gamma': ['auto'], ....}
                ...
                #It runs through all the different parameters that is fed into the parameter grid and 
                #produces the best combination of parameters, based on a scoring metric of your choice (accuracy, f1, etc)
